...
/* Test jacobian */
static int
IDA_Jac (realtype t, realtype cj, N_Vector y, N_Vector fy, N_Vector resvec, SlsMat JacMat, void *user_data, N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
    int n = 0;
...
/* Test jacobian */
static int
check_flag (void *flagvalue, const char *funcname, int opt, CLC_simulator simulator)
{
    int *errflag;
...
int
IDA_model (realtype t, N_Vector y, N_Vector ydot, N_Vector resval, void *user_data)
{
    int i;
