...
namespace MicroModelica {
  ...
  namespace IR {
    ...
    string 
    ProductFunction::print() const 
    {
      return "";
    }

    string 
    ProductFunction::code()
    {
      return "";
    }

    string 
    InnerProductFunction::print() const 
    {
      return "";
    }

    string 
    InnerProductFunction::code()
    {
      return "";
    }
