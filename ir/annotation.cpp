...
namespace MicroModelica {
  namespace IR {
    ...
    bool
    FunctionAnnotation::hasInclude()
    {
      return !_include.empty();
    }

    bool
    FunctionAnnotation::hasIncludeDirectory()
    {
      return !_includeDirectory.empty();
    }

    bool
    FunctionAnnotation::hasLibraries()
    {
      return !_libraries.empty();
    }

    bool
    FunctionAnnotation::hasLibraryDirectory()
    {
    ...
    string
    FunctionAnnotation::derivative()
    {
      return _derivative;
    }

    string
    FunctionAnnotation::include()
    {
      return _include;
    }

    string
    FunctionAnnotation::includeDirectory()
    {
    ...
    string
    FunctionAnnotation::libraryDirectory()
    {
    ...
    void
    ModelAnnotation::eventComment(AST_Comment x)
    {
      _weight = -1;
    ...
    PartitionMethod
    ModelAnnotation::partitionMethod()
    {
    ...
    void
    ModelAnnotation::setDesc(string desc)
    {
      _desc = desc;
    }

    string
    ModelAnnotation::desc()
    {
      return _desc;
    }

    void
    ModelAnnotation::setDQMin(double dqmin)
    {
      _DQMin.push_back(dqmin);
    }

    list<double>
    ModelAnnotation::dqmin()
    {
      return _DQMin;
    }

    void
    ModelAnnotation::setDT(double dt)
    {
      _dt = dt;
    }
    ...
    list<double>
    ModelAnnotation::dqrel()
    {
      return _DQRel;
    }

    void
    ModelAnnotation::setDQRel(double dqrel)
    {
      _DQRel.push_back(dqrel);
    }

    void
    ModelAnnotation::setWeight(double weight)
    {
      _weight = weight;
    }

    double
    ModelAnnotation::weight()
    {
      return _weight;
    }

    void
    ModelAnnotation::setSolver(Solver solver)
    {
      _solver = solver;
    }

    string
    ModelAnnotation::solverString()
    {
      return _solverString;
    }

    Solver
    ModelAnnotation::solver()
    {
      return _solver;
    }

    void
    ModelAnnotation::setPartitionMethod(PartitionMethod pm)
    {
      _partitionMethod = pm;
    }

    string
    ModelAnnotation::partitionMethodString()
    {
      return _partitionMethodString;
    }

    DT_Synch
    ModelAnnotation::dtSynch()
    {
      return _dtSynch;
    }

    string
    ModelAnnotation::dtSynchString()
    {
      return _dtSynchString;
    }

    void
    ModelAnnotation::setDtSynch(DT_Synch synch)
    {
      _dtSynch = synch;
    }

    void
    ModelAnnotation::setInitialTime(double it)
    {
      _initialTime = it;
    }

    double
    ModelAnnotation::initialTime()
    {
      return _initialTime;
    }

    void
    ModelAnnotation::setFinalTime(double ft)
    {
      _finalTime = ft;
    }

    double
    ModelAnnotation::finalTime()
    {
      return _finalTime;
    }

    void
    ModelAnnotation::setMinStep(double ms)
    {
      _minStep = ms;
    }

    double
    ModelAnnotation::minStep()
    {
      return _minStep;
    }

    void
    ModelAnnotation::setZCHyst(double zch)
    {
      _ZCHyst = zch;
    }

    double
    ModelAnnotation::ZCHyst()
    {
      return _ZCHyst;
    }

    void
    ModelAnnotation::setDerDelta(double dd)
    {
      _derDelta = dd;
    }

    double
    ModelAnnotation::derDelta()
    {
      return _derDelta;
    }

    void
    ModelAnnotation::setStoreData(string store)
    {
      _storeData = store;
    }

    string
    ModelAnnotation::storeData()
    {
      return _storeData;
    }

    void
    ModelAnnotation::setLps(int lps)
    {
      _lps = lps;
    }

    void
    ModelAnnotation::setJacobian(int jacobian)
    {
      _jacobian = jacobian;
    }

    int
    ModelAnnotation::jacobian()
    {
      return _jacobian;
    }

    bool
    ModelAnnotation::classic()
    {
      return _solver == DASSL || _solver == DOPRI
          || _solver == CVODE_BDF
          || _solver == IDA || _solver == CVODE_AM;
    }
    ...
    void
    ModelAnnotation::setNodeSize(int ns)
    {
      _nodeSize = ns;
    }

    int
    ModelAnnotation::nodeSize()
    {
      return _nodeSize;
    }

    void
    ModelAnnotation::setCommInterval(string ci)
    {
      _commInterval = ci;
    }

    string
    ModelAnnotation::commInterval()
    {
      return _commInterval;
    }

    void
    ModelAnnotation::setSample(double s)
    {
      _sample.push_back(s);
    }

    list<double>
    ModelAnnotation::sample()
    {
      return _sample;
    }

    void
    ModelAnnotation::setScheduler(string sched)
    {
      _scheduler = sched;
    }

    string
    ModelAnnotation::scheduler()
    {
      return _scheduler;
    }

    void
    ModelAnnotation::setSymDiff(bool sd)
    {
      _symDiff = sd;
    }

    bool
    ModelAnnotation::symDiff()
    {
      return _symDiff;
    }

    int
    ModelAnnotation::order()
    {
      return _order;
    }

    list<AST_Expression>
    ModelAnnotation::output()
    {
      return _output;
    }

    list<string>
    ModelAnnotation::patohSettings()
    {
      return _patohSettings;
    }

    list<string>
    ModelAnnotation::scotchSettings()
    {
      return _scotchSettings;
    }

    list<string>
    ModelAnnotation::metisSettings()
    {
      return _metisSettings;
    }

    void
    ModelAnnotation::setPatohSettings(string l)
    {
      _patohSettings.push_back(l);
    }

    void
    ModelAnnotation::setScotchSettings(string l)
    {
      _scotchSettings.push_back(l);
    }

    void
    ModelAnnotation::setMetisSettings(string l)
    {
    ...
    void
    AnnotationValue::setInteger(int i)
    {
      _integer = i;
    }

    double
    AnnotationValue::real()
    {
      return _real;
    }

    void
    AnnotationValue::setReal(double d)
    {
      _real = d;
    }
    ...
    void
    AnnotationValue::setStr(string s)
    {
      _str = s;
    }
    ...
    EvalAnnotation::EvalAnnotation(VarSymbolTable st) :
        _st(st), 
        _tokens()
    {
    ...
    AnnotationValue
    EvalAnnotation::foldTraverseElement(AST_Expression e)
    {
    ...
    AnnotationValue
    EvalAnnotation::foldTraverseElement(AnnotationValue e1, AnnotationValue e2, BinOpType bot)
    {
      AnnotationValue av = AnnotationValue();
      switch(bot)
      {
    ...
    AnnotationValue
    EvalAnnotation::foldTraverseElementUMinus(AST_Expression e)
    {
    ...
    void
    ModelAnnotation::setParallel(bool p)
    {
      _parallel = p;
    }

    bool
    ModelAnnotation::parallel()
    {
      return _parallel;
    }

    int
    ModelAnnotation::polyCoeffs()
    {
      return _polyCoeffs;
    }

    bool
    Annotation::hasDerivative()
    {
      return true;
    }

    bool
    Annotation::hasInclude()
    {
      return true;
    }

    bool
    Annotation::hasIncludeDirectory()
    {
      return true;
    }

    bool
    Annotation::hasLibraries()
    {
      return true;
    }

    bool
    Annotation::hasLibraryDirectory()
    {
      return true;
    }
    ...
    string
    Annotation::libraryDirectory()
    {
      return "";
    }

    void
    Annotation::eventComment(AST_Comment x)
    {
      return;
    }

    bool
    Annotation::insert(AST_Argument_Modification x)
    {
      return true;
    }

    void
    Annotation::setDesc(string desc)
    {
      return;
    }
    ...
    void
    Annotation::setDQMin(double dqmin)
    {
      return;
    }
    ...
    void
    Annotation::setDQRel(double dqrel)
    {
      return;
    }

    void
    Annotation::setWeight(double weight)
    {
      return;
    }
    ...
    void
    Annotation::setSolver(Solver solver)
    {
      return;
    }
    ...
    string
    Annotation::solverString()
    {
      return "";
    }

    void
    Annotation::setInitialTime(double it)
    {
      return;
    }

    double
    Annotation::initialTime()
    {
      return 0;
    }

    void
    Annotation::setFinalTime(double ft)
    {
      return;
    }

    double
    Annotation::finalTime()
    {
      return 0;
    }

    void
    Annotation::setMinStep(double ms)
    {
      return;
    }
    ...
    void
    Annotation::setZCHyst(double zch)
    {
      return;
    }
    ...
    void
    Annotation::setDerDelta(double dd)
    {
      return;
    }
    ...
    void
    Annotation::setLps(int lps)
    {
      return;
    }

    void
    Annotation::setDT(double dt)
    {
      return;
    }
    ...
    void
    Annotation::setCommInterval(string ci)
    {
      return;
    }

    string
    Annotation::commInterval()
    {
      return "";
    }

    void
    Annotation::setSample(double s)
    {
      return;
    }
    ...
    void
    Annotation::setScheduler(string sched)
    {
      return;
    }
    ...
    void
    Annotation::setStoreData(string save)
    {
      return;
    }
    ...
    void
    Annotation::setPartitionMethod(PartitionMethod pm)
    {
      return;
    }

    string
    Annotation::partitionMethodString()
    {
      return "";
    }

    PartitionMethod
    Annotation::partitionMethod()
    {
      return Metis;
    }

    void
    Annotation::setParallel(bool p)
    {
      return;
    }
    ...
    int
    Annotation::polyCoeffs()
    {
      return 2;
    }

    void
    Annotation::setDtSynch(DT_Synch synch)
    {
      return;
    }

    string
    Annotation::dtSynchString()
    {
      return "";
    }
    ...
    list<string>
    Annotation::patohSettings()
    {
      return list<string>();
    }

    list<string>
    Annotation::scotchSettings()
    {
      return list<string>();
    }

    list<string>
    Annotation::metisSettings()
    {
      return list<string>();
    }

    void
    Annotation::setPatohSettings(string l)
    {
      return;
    }

    void
    Annotation::setScotchSettings(string l)
    {
      return;
    }

    void
    Annotation::setMetisSettings(string l)
    {
      return;
    }
  }
