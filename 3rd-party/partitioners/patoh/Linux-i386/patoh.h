...
typedef int (*SingleArgumentCallBack)(PPaToH_Parameters pargs, char *variable,
    char *value, int ivalue, float fvalue);

int PaToH_Process_Arguments(PPaToH_Parameters pargs, int startargc, int argc,
 ...
 */
int PaToH_Part(PPaToH_Parameters pargs, int _c, int _n, int _nconst,
    int useFixCells,
...
int PaToH_Read_Hypergraph(char *filename, int *_c, int *_n, int *_nconst,
    int **cwghts, int **nwghts, int **xpins, int **pins);
int PaToH_Write_Hypergraph(char *filename, int numbering, int _c, int _n,
    int _nconst,
    int *cwghts, int *nwghts, int *xpins, int *pins);
