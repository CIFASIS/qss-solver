 ...
 */
void
LIQSS_BDF_recomputeNextTime(QA_quantizer quantizer, int var, double t,
    double *nTime, double *x, double *lqu, double *q) __attribute__((hot));
/**
 *
 * @param quantizer
 ...
 */
void
LIQSS_BDF_updateQuantizedState(QA_quantizer quantizer, int var, double *q,
    double *x, double *lqu) __attribute__((hot));
/**
 *
 * @param quantizer
 ...
 */
void
LIQSS_BDF_PAR_recomputeNextTimes(QA_quantizer quantizer, int vars, int *inf,
 ...
 */
void
LIQSS_BDF_PAR_recomputeNextTime(QA_quantizer quantizer, int var, double t,
    double *nTime, double *x, double *lqu, double *q) __attribute__((hot));
/**
 *
 * @param quantizer
 ...
 */
void
LIQSS_BDF_PAR_updateQuantizedState(QA_quantizer quantizer, int var, double *q,
    double *x, double *lqu) __attribute__((hot));
/**
 *
 * @param quantizer
