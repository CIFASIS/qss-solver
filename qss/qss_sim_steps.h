...
typedef void (*QSS_simStepsAddFn)(QSS_simSteps, IBX_message, int);

typedef bool (*QSS_simStepsEmptyFn)(QSS_simSteps);

typedef QSS_stepInfo (*QSS_simStepsItFn)(QSS_simSteps);

typedef void (*QSS_simStepsResetFn)(QSS_simSteps);
...
void QSS_freeSimStepsState(QSS_simStepsState state);
...
void QSS_freeSimStepsOps(QSS_simStepsOps ops);
...
void QSS_SIS_add(QSS_simSteps steps, IBX_message msg, int synch);

void QSS_SIS_reset(QSS_simSteps steps);

bool QSS_SIS_empty(QSS_simSteps steps);

QSS_stepInfo QSS_SIS_first(QSS_simSteps steps);

QSS_stepInfo QSS_SIS_next(QSS_simSteps steps);
