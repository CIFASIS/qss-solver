    ...
    switch (i)
    {
        ...
        default:
            ...
            if (j >= 1 && j <= 198)
            {
                ...
                dx[2] = (-(x[(j + 200) * 4 + 1] - x[(j + 199) * 4 + 1]) * 200 * __PAR_K0) / 2;
                dx[3] = (-__PAR_K0 * (x[(j + 200) * 4 + 2] * 2 - x[(j + 199) * 4 + 2] * 2) * 200) / 6;
            }
            j = i - 200;
            if (j >= 1 && j <= 198)
            {
                dx[1] = 1.0 / __PAR_rho0 * ((-x[(j + 1) * 4]) + x[(j) * 4]) * 200;
                dx[2] = (200 * (1.0 / (__PAR_rho0)) * (x[(j) * 4 + 1] - x[(j + 1) * 4 + 1])) / 2;
                dx[3] = ((1.0 / (__PAR_rho0)) * (x[(j) * 4 + 2] * 2 - x[(j + 1) * 4 + 2] * 2) * 200) / 6;
            }
            j = i - 400;
            if (j >= 1 && j <= 198)
            {
                dx[1] = (__PAR_u0 - __PAR_c) * ((-x[(j + 401) * 4]) + x[(j + 400) * 4]) * 200;
                dx[2] = (-200 * (__PAR_c - __PAR_u0) * (x[(j + 400) * 4 + 1] - x[(j + 401) * 4 + 1])) / 2;
                dx[3] = ((x[(j + 400) * 4 + 2] * 2 - x[(j + 401) * 4 + 2] * 2) * (__PAR_u0 - __PAR_c) * 200) / 6;
            }
            j = i - 600;
            if (j >= 1 && j <= 198)
            {
                dx[1] = (__PAR_u0 + __PAR_c) * ((-x[(j + 600) * 4]) + x[(j + 599) * 4]) * 200;
                dx[2] = (-(__PAR_c + __PAR_u0) * 200 * (x[(j + 600) * 4 + 1] - x[(j + 599) * 4 + 1])) / 2;
                dx[3] = (-(__PAR_c + __PAR_u0) * (x[(j + 600) * 4 + 2] * 2 - x[(j + 599) * 4 + 2] * 2) * 200) / 6;
            }
    }
}
...
MOD_dependencies (int i, double *x, double *d, double *alg, double t, double *der, int *map)
{
    ...
    if (j >= 1 && j <= 198)
    {
        ...
        der[(j + 200) * 4 + 2] = (200 * (1.0 / (__PAR_rho0)) * (x[(j) * 4 + 1] - x[(j + 1) * 4 + 1])) / 2;
        der[(j + 200) * 4 + 3] = ((1.0 / (__PAR_rho0)) * (x[(j) * 4 + 2] * 2 - x[(j + 1) * 4 + 2] * 2) * 200) / 6;
    }
    j = i - 1;
    if (j >= 1 && j <= 198)
    {
    ...
    if (j >= 1 && j <= 198)
    {
        ...
        der[(j) * 4 + 2] = (-(x[(j + 200) * 4 + 1] - x[(j + 199) * 4 + 1]) * 200 * __PAR_K0) / 2;
        der[(j) * 4 + 3] = (-__PAR_K0 * (x[(j + 200) * 4 + 2] * 2 - x[(j + 199) * 4 + 2] * 2) * 200) / 6;
    }
    j = i - 200;
    if (j >= 1 && j <= 198)
    {
    ...
    if (j >= 1 && j <= 198)
    {
        ...
        der[(j + 400) * 4 + 2] = (-200 * (__PAR_c - __PAR_u0) * (x[(j + 400) * 4 + 1] - x[(j + 401) * 4 + 1])) / 2;
        der[(j + 400) * 4 + 3] = ((x[(j + 400) * 4 + 2] * 2 - x[(j + 401) * 4 + 2] * 2) * (__PAR_u0 - __PAR_c) * 200) / 6;
    }
    j = i - 401;
    if (j >= 1 && j <= 198)
    {
    ...
    if (j >= 1 && j <= 198)
    {
        ...
        der[(j + 600) * 4 + 2] = (-(__PAR_c + __PAR_u0) * 200 * (x[(j + 600) * 4 + 1] - x[(j + 599) * 4 + 1])) / 2;
        der[(j + 600) * 4 + 3] = (-(__PAR_c + __PAR_u0) * (x[(j + 600) * 4 + 2] * 2 - x[(j + 599) * 4 + 2] * 2) * 200) / 6;
    }
    j = i - 600;
    if (j >= 1 && j <= 198)
    {
...
QSS_initializeDataStructs (QSS_simulator simulator)
{
    ...
    for (i0 = 0; i0 <= 199; i0++)
    {
        modelData->x[(i0) * 4] = pow (2.717999999999999971578291e+00,
                                      (-__PAR_beta * pow ((1.000000000000000000000000e+00 * (i0 + 1) / 200 - __PAR_x0), 2.0)))
                * cos (__PAR_gam * (1.000000000000000000000000e+00 * (i0 + 1) / 200 - __PAR_x0));
