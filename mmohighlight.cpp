...
MmoHighlighter::MmoHighlighter(QTextDocument *parent, h_type file)
  ...
  case MMO_MODEL:
    ...
    keywordPatterns << "\\bin\\b"
                    ...
                    << "\\bMMO_NodeSize\\b"
                    << "\\bMMO_Parallel\\b"
                    << "\\bMMO_PartitionMethod\\b"
                    << "\\bMMO_DT_Min\\b"
                    << "\\bMMO_Imbalance\\b"
                    << "\\bMMO_ReorderPartition\\b"
                    << "\\bMMO_DebugGraph\\b"
                    << "\\bMMO_GenerateArch\\b"
                    << "\\bMMO_DT_Synch\\b"
                    << "\\bMMO_PatohSettings\\b"
    ...
    annotationPatterns << "\\bannotation\\b"
                       << "\\bexperiment\\b";
