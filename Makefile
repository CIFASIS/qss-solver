...
ifeq ($(OS), Linux)
	cd ./cvode-2.9.0/build; cmake .. -DLAPACK_ENABLE=ON -DCMAKE_BUILD_TYPE=Release  -DKLU_ENABLE=ON -DKLU_INCLUDE_DIR=/usr/include/suitesparse -DKLU_LIBRARY_DIR=$(KLULIBDIR)  -DCMAKE_INSTALL_PREFIX=/usr
else
