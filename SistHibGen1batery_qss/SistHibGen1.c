...
int fsolve1_eval(const gsl_vector * __x, void * __p, gsl_vector * __f) {
  ...
  gsl_vector_set (__f,0, (boost_panel1_panel_exponente) - (1.6e-19*(boost_panel1_panel_Vpv/60+boost_panel1_panel_Ipv*0.01/1)/(6.58222e-21)));
  gsl_vector_set (__f,1, (boost_panel1_panel_Ipv-1*boost_panel1_panel_Iph+6.51513e-07*(exp(boost_panel1_panel_exponente)-1)) - (0));
  return GSL_SUCCESS;
}
void fsolve1(double boost_panel1_panel_Iph,double boost_panel1_panel_Vpv,double *boost_panel1_panel_Ipv,double *boost_panel1_panel_exponente) { 
  size_t __iter = 0;
  int __status,i;
...
int fsolve2_eval(const gsl_vector * __x, void * __p, gsl_vector * __f) {
  ...
  gsl_vector_set (__f,0, (boost_panel1_boost1_idealDiode_v) - (boost_panel1_boost1_idealDiode_s*1*(pre(d1)*(1)+(1-pre(d1))*(1e-05))+0));
  gsl_vector_set (__f,1, (boost_panel1_boost1_idealDiode_i) - (boost_panel1_boost1_idealDiode_s*1*(pre(d2)*(1e-05)+(1-pre(d2))*(1))+0));
  ...
  gsl_vector_set (__f,4, (boost_panel1_boost1_controlledIdealClosingSwitch_p_v-boost_panel1_boost1_controlledIdealClosingSwitch_n_v) - (boost_panel1_boost1_controlledIdealClosingSwitch_s*1*(pre(d3)*(1e-05)+(1-pre(d3))*(1))));
  gsl_vector_set (__f,5, (boost_panel1_boost1_controlledIdealClosingSwitch_p_i) - (boost_panel1_boost1_controlledIdealClosingSwitch_s*1*(pre(d4)*(1)+(1-pre(d4))*(1e-05))));
  gsl_vector_set (__f,6, (boost_panel1_boost1_controlledIdealClosingSwitch_p_v) - (boost_panel1_boost1_idealDiode_p_v));
  gsl_vector_set (__f,7, (boost_panel1_boost1_controlledIdealClosingSwitch_p_i+boost_panel1_boost1_idealDiode_p_i+boost_panel1_boost1_inductor_n_i) - (0));
  return GSL_SUCCESS;
}
void fsolve2(double boost_panel1_boost1_controlledIdealClosingSwitch_n_v,double boost_panel1_boost1_idealDiode_n_v,double boost_panel1_boost1_inductor_n_i,double d1,double d2,double d3,double d4,double *boost_panel1_boost1_idealDiode_v,double *boost_panel1_boost1_idealDiode_s,double *boost_panel1_boost1_idealDiode_p_v,double *boost_panel1_boost1_idealDiode_i,double *boost_panel1_boost1_controlledIdealClosingSwitch_s,double *boost_panel1_boost1_controlledIdealClosingSwitch_p_i,double *boost_panel1_boost1_controlledIdealClosingSwitch_p_v,double *boost_panel1_boost1_idealDiode_p_i) { 
  size_t __iter = 0;
  int __status,i;
  const gsl_multiroot_fsolver_type *__T = gsl_multiroot_fsolver_hybrid;
