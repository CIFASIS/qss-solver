...
AST_Statement_Assign_::AST_Statement_Assign_ (AST_Expression_ComponentReference lhs, AST_Expression exp) :
        _lhs (lhs), _exp (exp)
{
}
...
AST_Statement_For_::AST_Statement_For_ (AST_ForIndexList index, AST_StatementList sts) :
        _sts (sts), _ind (index)
{
}
...
AST_Statement_When_::AST_Statement_When_ (AST_Expression cond, AST_StatementList sts, AST_Statement_ElseList else_st, AST_Comment c) :
...
AST_Statement_While_::AST_Statement_While_ (AST_Expression cond, AST_StatementList sts) :
        _cond (cond), _sts (sts)
{
}
