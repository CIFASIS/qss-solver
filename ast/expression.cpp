...
AST_Expression_BinOp_::AST_Expression_BinOp_ (AST_Expression e1, AST_Expression e2, BinOpType t) :
        _e1 (e1), _e2 (e2), _t (t)
{
}
...
void
AST_Expression_ComponentReference_::append (AST_String s, AST_ExpressionList subs)
{
...
void
AST_Expression_ComponentReference_::prepend (AST_String s, AST_ExpressionList subs)
{
...
AST_Expression_If_ElseIf_::AST_Expression_If_ElseIf_ (AST_Expression c, AST_Expression t) :
        _cond (c), _then (t)
{
}
...
AST_Expression_NamedArgument_::AST_Expression_NamedArgument_ (AST_String name, AST_Expression exp) :
        _exp (exp), _name (name)
{
}
...
AST_Expression_ArrayIndex_::AST_Expression_ArrayIndex_ (AST_Expression exp, int size) :
        _exp (exp), _size (size)
{
}
