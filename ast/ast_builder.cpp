...
AST_Equation
newAST_Equation_Connect (AST_Expression_ComponentReference cr1, AST_Expression_ComponentReference cr2)
{
...
newAST_Element_Component (AST_DeclarationList cl, AST_String type, AST_TypePrefix tp, AST_ExpressionList ind)
{
...
AST_Expression
newAST_Expression_BinOp (AST_Expression left, AST_Expression right, BinOpType type)
{
