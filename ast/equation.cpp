...
AST_Equation_Equality_::AST_Equation_Equality_ (AST_Expression left, AST_Expression right) :
...
AST_Equation_Else_::AST_Equation_Else_ (AST_Expression cond, AST_EquationList eqs) :
        _cond (cond), _eqs (eqs)
{
}
