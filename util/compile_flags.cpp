...
namespace MicroModelica {
  namespace Util {
    ...
    void
    CompileFlags::setStore(bool s)
    {
      _store = s;
    }

    void
    CompileFlags::setIncidenceMatrices(bool im)
    {
      _incidenceMatrices = im;
    }

    void
    CompileFlags::setOptimizeQSS(bool s)
    {
      _optimizeQSS = s;
    }

    bool
    CompileFlags::incidenceMatrices()
    {
      return _incidenceMatrices;
    }

    bool
    CompileFlags::parallel()
    {
      return _parallel;
    }

    void
    CompileFlags::setParallel(bool s)
    {
      _parallel = s;
      setGraph(true);
    }
    ...
    void
    CompileFlags::setOutput(bool s)
    {
      _output = s;
    }

    bool
    CompileFlags::externalFunctions()
    {
      return _externalFunctions;
    }

    void
    CompileFlags::setExternalFunctions(bool s)
    {
    ...
    void
    CompileFlags::setDebug(int s)
    {
      _debug |= s;
    }

    void
    CompileFlags::setOutputFile(string outputFile)
    {
    ...
    string
    CompileFlags::outputFile()
    {
      return _outputFile;
    }

    bool
    CompileFlags::hasOutputFile()
    {
      return !_outputFile.empty();
    }

    void
    CompileFlags::setPath(string p)
    {
      _path = p;
    }
    ...
    list<string>
    CompileFlags::libraryPaths()
    {
      return _libraryPaths;
    }

    void
    CompileFlags::addLibraryPath(string l)
    {
      _libraryPaths.push_back(l);
    }

    void
    CompileFlags::addObject(string o)
    {
      _objects.insert(pair<string, string>(o, o));
    }

    list<string>
    CompileFlags::objects()
    {
      list<string> ret;
    ...
    bool
    CompileFlags::optimizeQSS()
    {
      return _optimizeQSS;
    }

    bool
    CompileFlags::hasObjects()
    {
      return !_objects.empty();
    }

    bool
    CompileFlags::externalStructureFile()
    {
      return _externalStructureFiles;
    }

    void
    CompileFlags::setExternalStructureFile(bool s)
    {
      _externalStructureFiles = s;
    }

    void
    CompileFlags::setDebug(string s)
    {
