...
namespace MicroModelica {
  namespace Util {
    ...
    PartialEvalExp::PartialEvalExp(VarSymbolTable symbolTable) {
    ...
    AST_Expression PartialEvalExp::foldTraverseElementUMinus(AST_Expression exp) {
      ...
      return (
          foldTraverseElement(zero, apply(exp->getAsUMinus()->exp()), BINOPSUB));
    }

    AST_Expression PartialEvalExp::foldTraverseElement(AST_Expression left,
    ...
    bool PartialEvalExp::shouldReturnInteger(AST_Expression left,
                                             AST_Expression right) {
