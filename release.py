#!/usr/bin/env python3
"""
Release script for QSS Solver
Automates the release procedure as described in deploy/linux/README.md
"""
...
def main():
    parser = argparse.ArgumentParser(description="QSS Solver Release Script")
    ...
    print(f"Step 4: Merging {repo_name}-dev into {repo_name}-release...")
    ...
    print("Step 6: Running update.sh...")
    if not args.skip_tests:
        run_command("./update.sh")
    else:
        print("Skipping update.sh (tests) as requested")
