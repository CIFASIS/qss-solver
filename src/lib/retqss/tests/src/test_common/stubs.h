#ifndef _RETQSS_TEST_STUBS_H_
#define _RETQSS_TEST_STUBS_H_

#include <stdio.h>

typedef void *FcnEqDiff;
typedef void *SolTrait;
typedef void *ZeroCrossing;
typedef void *dae_system;
typedef void *nullfunc;
typedef void *zero_crossing;
