...
const QStringList MmoHighlighter::_model_qss_tags = {
    "CI_Dense",    "CI_Sampled", "CI_Step",   "CQSS1",     "CQSS2",     "CQSS3",  "CVODE_AM", "CVODE_BDF",
    "DASSL",       "Dense",      "DOPRI",     "false",     "HMetis",    "IDA",    "KaHIP",    "LIQSS",
    "LIQSS2",      "LIQSS3",     "LIQSS_BDF", "Manual",    "Metis",     "mLIQSS", "mLIQSS2",  "MTPL",
    "MTPL_IT",     "Patoh",      "QSS",       "QSS2",      "QSS3",      "QSS4",   "Scotch",   "SD_DT_Asynchronous",
