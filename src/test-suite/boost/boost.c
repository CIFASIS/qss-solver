...
MOD_definition(int i, double *x, double *d, double *alg, double t, double *dx)
{
	switch(i)
	{
		case 0:
			...
			alg[0 + 1] = (1.0/(d[(1)]+d[(0)]))*(d[(1)]*x[4]-x[1]);
			dx[1] = (alg[0]-x[0]/__PAR_R)/__PAR_C;
			dx[2] = (-((1.0/(__PAR_R))*x[1]-alg[1])*(1.0/(__PAR_C)))/2;
			return;
		case 1:
			alg[0] = (d[(1)]*x[3]-x[0])/(d[(0)]+d[(1)]);
			alg[0 + 1] = (1.0/(d[(1)]+d[(0)]))*(d[(1)]*x[4]-x[1]);
			dx[1] = (__PAR_U-d[(1)]*(x[3]-alg[0]))/__PAR_L;
			dx[2] = (-(x[4]-alg[1])*(1.0/(__PAR_L))*d[(1)])/2;
			return;
	}
}
...
MOD_dependencies(int i, double *x, double *d, double *alg, double t, double *der, int *map)
{
	switch(i)
	{
		case 0:
			...
			der[0 + 2] = (-((1.0/(__PAR_R))*x[1]-alg[1])*(1.0/(__PAR_C)))/2;
			der[3 + 1] = (__PAR_U-d[(1)]*(x[3]-alg[0]))/__PAR_L;
			der[3 + 2] = (-(x[4]-alg[1])*(1.0/(__PAR_L))*d[(1)])/2;
			return;
		case 1:
			alg[0] = (d[(1)]*x[3]-x[0])/(d[(0)]+d[(1)]);
			alg[0 + 1] = (1.0/(d[(1)]+d[(0)]))*(d[(1)]*x[4]-x[1]);
