...
void usage()
{
  ...
  cout << "                Set SBML function replacement for MicroModelica, each MathML function defined in the model translated into "
       << endl;
  cout << "                an algebraic variable in MicroModelica. When translating an SBML model into BioRica, this is the only behavior"
       << endl;
...
int main(int argc, char* argv[])
{
  ...
  while (1) {
    static struct option long_options[] = {{"version", no_argument, 0, 'v'},      {"help", no_argument, 0, 'h'},
                                           {"type", required_argument, 0, 't'},   {"replace-functions", no_argument, 0, 'r'},
