...
void AST_Element_::accept(AST_Visitor *visitor) { visitor->visit(this); }
...
bool AST_Element_Component_::hasIndexes() { return !_indexes->empty(); }
...
string AST_Element_ImportClause_::name() const { return _name; }

ElementType AST_Element_ImportClause_::elementType() { return IMPORT; }
...
void AST_Comment_::accept(AST_Visitor *visitor) { visitor->visit(this); }
