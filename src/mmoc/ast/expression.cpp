...
void AST_Expression_::accept(AST_Visitor *visitor) { visitor->visit(this); }
...
AST_Integer AST_Expression_Integer_::val() { return _i; }
...
string AST_Expression_String_::str() const { return _s; }
...
AST_Expression AST_Expression_UMinus_::exp() const { return _e; }
...
AST_Expression AST_Expression_BooleanNot_::exp() const { return _e; }
...
AST_StringList AST_Expression_ComponentReference_::names() const { return _name; }

const char *AST_Expression_ComponentReference_::cname() { return name().c_str(); }
...
AST_ExpressionListList AST_Expression_ComponentReference_::indexes() const { return _indexes; }
...
AST_Expression_If_::AST_Expression_If_(AST_Expression cond, AST_Expression then, AST_Expression else_exp, AST_ExpressionList elseif_list)
...
AST_Expression AST_Expression_If_::else_exp() const { return _else_exp; }

AST_ExpressionList AST_Expression_If_::elseif_list() const { return _elseif_list; }

AST_Expression AST_Expression_If_::condition() const { return _cond; }

AST_Expression AST_Expression_If_::then() const { return _then; }
...
AST_Expression_If_ElseIf AST_Expression_::getAsElseIf() { return dynamic_cast<AST_Expression_If_ElseIf>(this); }

ExpressionType AST_Expression_If_ElseIf_::expressionType() { return EXPELSEIF; }

AST_Expression AST_Expression_If_ElseIf_::condition() { return _cond; }

AST_Expression AST_Expression_If_ElseIf_::then() { return _then; }
...
string AST_Expression_If_::print() const
{
  ...
  if (!elseif_list()->empty()) foreach (it, elseif_list())
...
string AST_Expression_End_::print() const { return "end"; }

/* Output expression Class */

AST_Expression_Output_::AST_Expression_Output_(AST_ExpressionList l) : _list(l) {}

ExpressionType AST_Expression_Output_::expressionType() { return EXPOUTPUT; }
...
AST_ExpressionList AST_Expression_Output_::expressionList() { return _list; }

/* Range expression Class */

AST_Expression_Range_::AST_Expression_Range_(AST_ExpressionList l) : _list(l) {}

ExpressionType AST_Expression_Range_::expressionType() { return EXPRANGE; }
...
AST_ExpressionList AST_Expression_Range_::expressionList() { return _list; }
...
AST_Expression_NamedArgument_::AST_Expression_NamedArgument_(AST_String name, AST_Expression exp) : _exp(exp), _name(name) {}

ExpressionType AST_Expression_NamedArgument_::expressionType() { return EXPNAMEDARGUMENT; }

string AST_Expression_NamedArgument_::print() const
{
  stringstream ret;
  return ret.str();
}

AST_Expression AST_Expression_NamedArgument_::expression() { return _exp; }

AST_String AST_Expression_NamedArgument_::name() { return _name; }

AST_Expression_ArrayIndex_::AST_Expression_ArrayIndex_(AST_Expression exp, int size) : _exp(exp), _size(size) {}

ExpressionType AST_Expression_ArrayIndex_::expressionType() { return EXPARRAYINDEX; }

string AST_Expression_ArrayIndex_::print() const { return ""; }

AST_Expression AST_Expression_ArrayIndex_::expression() { return _exp; }

int AST_Expression_ArrayIndex_::size() { return _size; }
