...
void AST_Equation_::accept(AST_Visitor *visitor) { visitor->visit(this); }
...
void AST_Equation_Equality_::setLeft(AST_Expression e) { _left = e; }
...
AST_Equation_Connect_::AST_Equation_Connect_(AST_Expression_ComponentReference cr1, AST_Expression_ComponentReference cr2)
    : _cr1(cr1), _cr2(cr2)
{
}
...
AST_Expression AST_Equation_Call_::call() const { return _call; }
...
AST_Equation_If_::AST_Equation_If_(AST_Expression cond, AST_EquationList eql, AST_Equation_ElseList elseif, AST_EquationList else_eq)
...
AST_Equation_For_::AST_Equation_For_(AST_ForIndexList ind, AST_EquationList eql) : _eql(eql), _ind(ind) {}
