...
AST_Composition newAST_Composition() { return (new AST_Composition_(newAST_ElementList(), newAST_CompositionElementList())); }

AST_Composition newAST_Composition(AST_ElementList el) { return new AST_Composition_(el, newAST_CompositionElementList()); }

AST_Composition newAST_Composition(AST_ElementList el, AST_CompositionElementList cl) { return new AST_Composition_(el, cl); }

AST_Composition newAST_Composition(AST_CompositionElementList cl) { return new AST_Composition_(newAST_ElementList(), cl); }

AST_ElementList newAST_ElementList() { return new list<AST_Element>(); }

AST_Element AST_ImportToElement(AST_Element_ImportClause i) { return i; }

AST_Element AST_ExtendsToElement(AST_Element_ExtendsClause e) { return e; }
...
AST_Element newAST_Element_ClassWrapper(AST_Class c) { return new AST_Element_ClassWrapper_(c); }

AST_Element AST_Element_ComponentToElement(AST_Element_Component c) { return c; }

AST_CompositionElementList newAST_CompositionElementList() { return new list<AST_CompositionElement>(); }

AST_Element_ImportClause newAST_ImportClause(AST_String name) { return new AST_Element_ImportClause_(*name); }

AST_Expression newAST_Expression_Integer(int i) { return new AST_Expression_Integer_(i); }

AST_ExpressionList newAST_ExpressionList(AST_Expression e) { return newAST_SimpleList(e); }
...
AST_Expression newAST_Expression_Real(AST_Real r) { return new AST_Expression_Real_(r); }
...
AST_Expression newAST_Expression_Boolean(AST_Boolean b) { return new AST_Expression_Boolean_(b); }

AST_Expression newAST_Expression_Derivative(AST_ExpressionList el) { return new AST_Expression_Derivative_(el); }

AST_Class newAST_Class(AST_String s) { return newAST_Class(s, newAST_Composition()); }

AST_Class newAST_Class(AST_String s, AST_Composition comp) { return new AST_Class_(s, comp); }
...
AST_DeclarationList newAST_DeclarationList(AST_Declaration d) { return newAST_SimpleList(d); }

AST_CompositionElement newAST_CompositionElement(AST_ElementList el) { return new AST_CompositionElement_(el); }
...
AST_Expression_ComponentReference AST_Expression_ComponentReference_AddDot(AST_Expression_ComponentReference cr, AST_String s,
...
AST_Element_ComponentList newAST_Element_ComponentList() { return new list<AST_Element_Component>(); }

AST_TypePrefix newAST_TypePrefix() { return 0; }

AST_TypePrefix newAST_TypePrefix(AST_TypePrefix tp) { return tp; }

AST_TypePrefix AST_TypePrefixAdd(AST_TypePrefix tp, AST_TypePrefix tpadd) { return tp | tpadd; }
...
AST_StringList newAST_StringList() { return new list<AST_String>(); }

AST_Expression newAST_Expression_End() { return new AST_Expression_End_(); }

AST_Expression newAST_Expression_Null() { return new AST_Expression_Null_(); }
...
AST_ClassPrefix AST_ClassPrefix_Class() { return CP_CLASS; }

AST_ClassPrefix AST_ClassPrefix_Model() { return CP_MODEL; }
...
AST_ClassPrefix AST_ClassPrefix_Block() { return CP_BLOCK; }
...
AST_ClassPrefix AST_ClassPrefix_Type() { return CP_TYPE; }

AST_ClassPrefix AST_ClassPrefix_Package() { return CP_PACKAGE; }

AST_ClassPrefix AST_ClassPrefix_Function(AST_ClassPrefix p) { return CP_FUNCTION | p; }

AST_ClassPrefix AST_ClassPrefix_Operator() { return CP_OPERATOR; }
...
AST_ClassPrefix AST_ClassPrefix_None() { return 0; }
...
AST_Equation newAST_EquationFor(AST_ForIndexList ind, AST_EquationList eql) { return new AST_Equation_For_(ind, eql); }

AST_ForIndex newAST_ForIndex(AST_String ident, AST_Expression exp) { return new AST_ForIndex_(ident, exp); }

AST_ForIndexList newAST_ForIndexList() { return new list<AST_ForIndex>(); }

AST_Equation newAST_Equation_For(AST_ForIndexList ind, AST_EquationList eql) { return new AST_Equation_For_(ind, eql); }
...
AST_Equation_Else newAST_Equation_Else(AST_Expression cond, AST_EquationList eqs) { return new AST_Equation_Else_(cond, eqs); }

AST_StatementList newAST_StatementList() { return new list<AST_Statement>(); }

AST_Statement newAST_Statement_Break() { return new AST_Statement_Break_(); }
...
AST_Equation_ElseList newAST_Equation_ElseList() { return new list<AST_Equation_Else>(); }

AST_ArgumentList newAST_ArgumentList() { return new list<AST_Argument>(); }

AST_Argument newAST_Argument_Modification(AST_String s, AST_Modification m) { return new AST_Argument_Modification_(s, m); }

AST_ExpressionListList newAST_ExpressionListList() { return new list<AST_ExpressionList>(); }

AST_Argument AST_ArgumentSetReplaceable(AST_Argument arg) { return arg; }

AST_Modification newAST_Modification_Equal(AST_Expression e) { return new AST_Modification_Equal_(e); }

AST_Modification newAST_Modification_Assign(AST_Expression e) { return new AST_Modification_Assign_(e); }
...
AST_Expression newAST_Expression_OutputExpressions(AST_ExpressionList exp_list) { return new AST_Expression_Output_(exp_list); }
...
AST_Statement_Else newAST_Statement_Else(AST_Expression cond, AST_StatementList st) { return new AST_Statement_Else_(cond, st); }

AST_Statement newAST_Statement_If(AST_Expression cond, AST_StatementList true_st, AST_Statement_ElseList else_st,
                                  AST_StatementList false_st)
{
  return new AST_Statement_If_(cond, true_st, else_st, false_st);
}

AST_Statement newAST_Statement_For(AST_ForIndexList index, AST_StatementList st) { return new AST_Statement_For_(index, st); }

AST_Statement newAST_Statement_While(AST_Expression cond, AST_StatementList st) { return new AST_Statement_While_(cond, st); }
...
AST_CompositionEqsAlgs newAST_CompositionEquations(AST_EquationList eqlist) { return new AST_CompositionEqsAlgs_(eqlist); }

AST_CompositionEqsAlgs newAST_CompositionInitialAlgorithms(AST_StatementList stlist) { return new AST_CompositionEqsAlgs_(stlist, true); }

AST_CompositionEqsAlgs newAST_CompositionAlgorithms(AST_StatementList stlist) { return new AST_CompositionEqsAlgs_(stlist); }
...
AST_Modification newAST_Modification_Class(AST_ArgumentList al, AST_Expression e) { return new AST_Modification_Class_(al, e); }

AST_CompositionElement newAST_CompositionElement(AST_CompositionEqsAlgs comp_eq_algs) { return new AST_CompositionElement_(comp_eq_algs); }
