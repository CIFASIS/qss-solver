...
#ifdef QSS_PARALLEL
void SAM_PAR_writeOutvar(OUT_output output, QSS_data simData, QSS_time simTime, SD_output simOutput, int index, int variable)
#else
void SAM_writeOutvar(OUT_output output, QSS_data simData, QSS_time simTime, SD_output simOutput, int index, int variable)
#endif
{
