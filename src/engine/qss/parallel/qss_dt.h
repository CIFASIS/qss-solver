 ...
 * @param
 */
typedef bool (*QSS_dtLogOutputFn)(QSS_dt, double, double, double, int);

typedef bool (*QSS_dtLogStepFn)(QSS_dt, double, double, double);
 ...
 * @param ops
 */
void QSS_freeDtOps(QSS_dtOps ops);
...
bool QSS_dtLogOutput(QSS_dt dt, double Dq, double Dx, double Dt, int variable);
 ...
 * @return
 */
bool QSS_dtLogStep(QSS_dt dt, double Dq, double Dx, double Dt);
