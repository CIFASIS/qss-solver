...
typedef int (*CLC_fpr)(int);

typedef void (*CLC_fpa)(int);

typedef void (*CLC_eq)(double *, double *, double *, double, double *);

typedef void (*CLC_zc)(int, double *, double *, double *, double, double *);

typedef void (*CLC_hnd)(int, double *, double *, double *, double);

typedef void (*CLC_input)(double, double *);
...
void CLC_freeEvent(CLC_event events);
...
CLC_model CLC_Model(CLC_eq f, CLC_zc zeroCrossing, CLC_hnd handlerPos, CLC_hnd handlerNeg, CLC_jac);

void CLC_freeModel(CLC_model model);

typedef void (*CLC_setData)(CLC_data, SD_output, CLC_model, SD_simulationSettings);
