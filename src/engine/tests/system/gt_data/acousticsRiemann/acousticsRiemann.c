...
void MOD_definition(int i, double *x, double *d, double *alg, double t, double *dx)
{
  int i0 = i;
  int j0 = 0;
  switch (i) {
...
void MOD_dependencies(int i, double *x, double *d, double *alg, double t, double *der, int *map)
{
  int i0 = i;
  int j0 = 0;
  switch (i) {
...
void MOD_output(int i, double *x, double *d, double *alg, double t, double *out)
{
  int i0 = i;
  int j0 = 0;
  j0 = i0;
...
void QSS_initializeDataStructs(QSS_simulator simulator)
{
  ...
  for (i0 = 0; i0 <= 99; i0++) {
    ...
    __PAR_p0[(i0)] = pow(2.717999999999999971578291e+00, (-__PAR_beta * pow((__PAR_x[(i0)] - __PAR_x0), 2.0))) *
                     cos(__PAR_gam * (__PAR_x[(i0)] - __PAR_x0));
