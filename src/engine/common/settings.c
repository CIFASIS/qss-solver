...
SD_Solver _getSolver(const char *sol)
{
  if (!strcmp(sol, "QSS1")) {
    ...
    return SD_CVODE_AM;
  } else if (!strcmp(sol, "CQSS1")) {
    return SD_CQSS1;
  } else if (!strcmp(sol, "CQSS2")) {
    return SD_CQSS2;
  } else if (!strcmp(sol, "CQSS3")) {
    return SD_CQSS3;
  } else if (!strcmp(sol, "CHEQSS1")) {
    return SD_CHEQSS1;
  } else if (!strcmp(sol, "CHEQSS2")) {
    return SD_CHEQSS2;
  } else if (!strcmp(sol, "CHEQSS3")) {
    return SD_CHEQSS3;
  } else if (!strcmp(sol, "EQSS1")) {
    return SD_EQSS1;
  } else if (!strcmp(sol, "EQSS2")) {
    return SD_EQSS2;
