model pic_nodes_2
    ...
    discrete Boolean is_entry_evt[N_PART];
    ...
    initial algorithm
        ...
        status := retQSS_setUp(N_PART, "geom/pic_nodes.vtk", "pic_nodes");
    ...
    algorithm
        ...
        for i in 1:N_PART loop
            ...
            // Actions:
            //  * Remove charge from previous cell (since we are about to
            //    deposit charge in current cell).
            ...
            // Actions:
            //  * Set random initial conditions (position along the first
            //    column of the grid).
