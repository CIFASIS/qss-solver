...
MOD_definition (int i, double *x, double *d, double *alg, double t, double *dx)
{
    ...
    if (j >= 0 && j <= 1999)
    {
        dx[1] = (__PAR_THA / __PAR_RES[(j)] - __PAR_POT[(j)] * d[(j)] - x[(j) * 3] / __PAR_RES[(j)] + d[(j + 6000)] / __PAR_RES[(j)])
                / __PAR_CAP[(j)];
...
MOD_dependencies (int i, double *x, double *d, double *alg, double t, double *der, int *map)
{
    ...
    if (j >= 0 && j <= 1999)
    {
        ...
        {
            der[(j) * 3 + 1] = (__PAR_THA / __PAR_RES[(j)] - __PAR_POT[(j)] * d[(j)] - x[(j) * 3] / __PAR_RES[(j)] + d[(j + 6000)] / __PAR_RES[(j)])
                    / __PAR_CAP[(j)];
