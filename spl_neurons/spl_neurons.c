...
MOD_definition (int i, double *x, double *d, double *alg, double t, double *dx)
{
    ...
    if (j >= 0 && j <= 2999)
    {
        dx[1] = d[(j)] * ((__PAR_vrest - x[(j) * 3]) + x[(j + 3000) * 3] * (__PAR_Eex - x[(j) * 3]) + x[(j + 6000) * 3] * (__PAR_Einh - x[(j) * 3]))
                / __PAR_tau;
    }
    j = i - 3000;
    if (j >= 0 && j <= 2999)
...
MOD_dependencies (int i, double *x, double *d, double *alg, double t, double *der, int *map)
{
    ...
    if (j >= 0 && j <= 2999)
    {
        ...
        {
            der[(j) * 3 + 1] = d[(j)]
                    * ((__PAR_vrest - x[(j) * 3]) + x[(j + 3000) * 3] * (__PAR_Eex - x[(j) * 3]) + x[(j + 6000) * 3] * (__PAR_Einh - x[(j) * 3]))
                    / __PAR_tau;
        }
    }
    j = i - 3000;
