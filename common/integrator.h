...
void INT_freeIntegratorOps(INT_integratorOps ops);

void INT_initialize(INT_integrator integrator, SIM_simulator simulator);

void INT_integrate(INT_integrator integrator, SIM_simulator simulator);
