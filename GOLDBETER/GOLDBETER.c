...
MOD_definition (int i, double *x, double *d, double *alg, double t, double *dx)
{
    switch (i)
    {
        case 0:
            ...
            return;
        case 1:
            dx[1] = (x[0] * 1.000000000000000000000000e+00 / (__PAR_kc + x[0])) * __PAR_vm1 * (1.0 - x[3]) * 1.000000000000000000000000e+00
                    / (__PAR_k1 + (1.0 - x[3])) - __PAR_v2 * x[3] * 1.000000000000000000000000e+00 / (__PAR_k2 + x[3]);
            return;
        case 2:
            dx[1] = x[3] * __PAR_vm3 * (1.0 - x[6]) * 1.000000000000000000000000e+00 / (__PAR_k3 + (1.0 - x[6]))
                    - __PAR_v4 * x[6] * 1.000000000000000000000000e+00 / (__PAR_k4 + x[6]);
            return;
    }
}
...
MOD_dependencies (int i, double *x, double *d, double *alg, double t, double *der, int *map)
{
    switch (i)
    {
        case 0:
            ...
            der[3 + 1] = (x[0] * 1.000000000000000000000000e+00 / (__PAR_kc + x[0])) * __PAR_vm1 * (1.0 - x[3]) * 1.000000000000000000000000e+00
                    / (__PAR_k1 + (1.0 - x[3])) - __PAR_v2 * x[3] * 1.000000000000000000000000e+00 / (__PAR_k2 + x[3]);
            return;
        case 1:
            der[3 + 1] = (x[0] * 1.000000000000000000000000e+00 / (__PAR_kc + x[0])) * __PAR_vm1 * (1.0 - x[3]) * 1.000000000000000000000000e+00
                    / (__PAR_k1 + (1.0 - x[3])) - __PAR_v2 * x[3] * 1.000000000000000000000000e+00 / (__PAR_k2 + x[3]);
            der[6 + 1] = x[3] * __PAR_vm3 * (1.0 - x[6]) * 1.000000000000000000000000e+00 / (__PAR_k3 + (1.0 - x[6]))
                    - __PAR_v4 * x[6] * 1.000000000000000000000000e+00 / (__PAR_k4 + x[6]);
            return;
        case 2:
            der[0 + 1] = __PAR_vi - __PAR_vd * x[6] * (x[0] * 1.000000000000000000000000e+00 / (__PAR_Kd + x[0])) - __PAR_kd * x[0];
